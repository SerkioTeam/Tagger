describe('Serkio tagger', function()
    ...
    describe('time conversion functionality', function()
        ...
        it('`time_to_seconds` should convert to `HH:MM:SS` format', function()
                assert.are_equal('01:01:07', tagger:seconds_to_time(3667))
        end)

        it('`seconds_to_time` should convert seconds to `HH:MM:SS` format', function()
                assert.are_equal(7, tagger:time_to_seconds('00:00:07'))
                assert.are_equal(67, tagger:time_to_seconds('00:01:07'))
                assert.are_equal(3667, tagger:time_to_seconds('01:01:07'))
        end)
    end)
end)
